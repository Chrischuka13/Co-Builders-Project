  ...
  return (
    <div className="flex-1 px-4 md:px-8 lg:px-12 py-6 bg-gray-50 min-h-screen">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
        <h3 className="text-2xl font-semibold text-[#31417F]">My Appointment</h3>
        <button
          onClick={() => navigate("/booking")}
          className="bg-[#31417F] hover:bg-[#6171ae] text-white px-4 py-2 rounded-md hover:cursor-pointer"
        >
          Add New Booking
        </button>
      </div>
      ...
      <div className="bg-white rounded-lg p-6 shadow-sm min-h-[60vh]">
        {filteredOrders.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full text-center">
            ...
            <button
              onClick={() => navigate("/booking")}
              className="bg-[#31417F] hover:bg-[#6171ae] text-white px-5 py-2 rounded-md hover:cursor-pointer"
            >
              Add New Booking
            </button>
          </div>
